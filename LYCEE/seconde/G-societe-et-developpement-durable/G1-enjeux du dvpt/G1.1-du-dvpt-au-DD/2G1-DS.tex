...
\question[1] Pourquoi est-ce un indicateur utile dans la définition de la notion de développement.
\question[6] Etudie cette carte (utilise le vocabulaire approprié). N'oublie pas de toujours justifié tes idées par des chiffres de la carte.
 ...
 \question[10] Explique, avec des arguments et des exemples, la relation complexe entre l'augmentation de la population et les modes durables de développement. Plan détaillé
