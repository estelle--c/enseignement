...
% Combien de mosquée à Bagdad.
% Voir qe c'est un lieu de culte, ms aussi de culture (bibliothèque et savants y résident).
% but pr le calife : construire la plus belle mosquée afin d'y attirer gens du monde entier.
